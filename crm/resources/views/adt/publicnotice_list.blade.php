...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加类型','publicnotice_add')"><i class="layui-icon"></i>添加</button>
    ...
    <table class="layui-table">
        ...
        @foreach($data as $v)
            <tr>
                ...
                <td class="td-manage">
                    <a title="查看"  onclick="x_admin_show('编辑','publicnotice_save?id={{$v->id}}')" href="javascript:;">
...
<script>
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            var publicnotice_id = id;
            $.get('publicnotice_del',{
                id:publicnotice_id
            },function(data){
                if(data == 1){
                    //发异步删除数据
