                ...
                <div class="layui-input-inline">
                    <select name="customer_id" id="customer_id">
                        ...
                        @foreach($customer as $v)
                            <option value="{{$v->c_id}} " <?php if($data->customer_id == $v->c_id){ echo 'selected'; }?>>{{$v->c_name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="layui-input-inline">
                    <select name="contype_id" id="contype_id">
                        <option>合同类型</option>
                        @foreach($contype as $val)
                            <option value="{{$val->contype_id}}" <?php if($data->contype_id == $val->contype_id){ echo 'selected'; } ?>>{{$val->contype_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="c_rebate" name="c_name" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{$data->c_rebate}}">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="text" id="c_ctime" name="c_name" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{$data->c_ctime}}">
            </div>
            <div class="layui-form-item">
                <label for="username" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="c_utime" name="c_name" required="" lay-verify="required"
                           autocomplete="off" class="layui-input" value="{{$data->c_utime}}">
                </div>
            </div>
            <div class="layui-form-item">
