...
<html>
  ...
  <body>
		...
		@foreach($res as $v)
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="删除" onclick="member_del(this,'{{$v->product_id}}','{{$v->order_number}}')" href="javascript:;">
    ...
    <script>
      ...
      /*用户-删除*/
      function member_del(obj,id,o_id){
          layer.confirm('确认要删除吗？',function(index){
			  //alert(id);

			  $.get("/del_opro",{id:id,order_number:o_id},function(data){
				  if(data==1){
