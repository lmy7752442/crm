...
<div class="x-body">
    <div class="layui-form">
        ...
        <input type="hidden" name="power_id" value="{{$res->power_id}}">
        <!-- 权限规则 -->
        <div class="layui-form-item">
            <label for="p_rule" class="layui-form-label">
                <span class="x-red">*</span>权限规则
            </label>
            <div class="layui-input-inline">
                <input type="text" id="p_rule" value="{{$res->p_rule}}" name="p_rule" required="" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="p_name" value="{{$res->p_name}}" name="p_name" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <!-- 修改 -->
