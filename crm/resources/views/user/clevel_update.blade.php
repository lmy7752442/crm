    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="hidden" id="hi" value="{{$data->clevel_id}}">
                <input type="text" id="clevel" name="c_name" required="" lay-verify="required" value="{{$data->clevel_name}}"
