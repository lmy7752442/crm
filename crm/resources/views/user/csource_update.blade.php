    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="hidden" id="hi" value="{{$data->csource_id}}">
                <input type="text" id="csource" name="c_name" required="" lay-verify="required" value="{{$data->csource_name}}"
